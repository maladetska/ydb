...
public:
    ...
    struct TSessionPoolStatCollector {
        ...
        // OpenTelemetry connection pool metrics (session == connection in YDB).
        // See https://opentelemetry.io/docs/specs/semconv/database/database-metrics/#connection-pool
